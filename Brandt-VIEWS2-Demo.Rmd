...
This is an example of what goes into a CRPS calculation for a set of observations scored against their forecast densities.
...
This shows how to use the basic `scoringutils` package functions to score the list of forecasts constructed in `count.out`.
